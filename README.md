...
`LLM_MARKDOWN_FETCH_PROXY`, `LLM_MARKDOWN_SEARCH_PROXY`, `LLM_MARKDOWN_IMAGE_SEARCH_PROXY`, `LLM_FETCH_ALLOW_PRIVATE=False`, `LLM_SUMMARIZE_CONCURRENCY=4`, `LLM_MODEL_SMALL` (optional, summarize uses this else `LLM_MODEL`).
